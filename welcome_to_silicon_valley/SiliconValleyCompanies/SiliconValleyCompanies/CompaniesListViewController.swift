...
//
//
//  Created by Sravanthi Rani Sinha on 5/26/16.
//
//
...
class CompaniesListViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
         ...
         let cell:UITableViewCell = self.tableView.dequeueReusableCellWithIdentifier("CompanyCell", forIndexPath :indexPath)
